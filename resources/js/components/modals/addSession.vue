                ...
                <form class="user" @submit.prevent="save" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <!-- <div class="col-md-12">
                                <div class="input-group mb-3">
                                    <input type="text" placeholder="what are you looking for?" v-model="form.searchVal" v-on:keyup="autoComplete" class="form-control">
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <datepicker name="date" v-model="form.schedule" input-class ="dpicker" :bootstrap-styling=true></datepicker>
                        </div>
                        <div class="form-group">
