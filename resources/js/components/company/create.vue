                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id=""
                                                        placeholder="Enter Product name" v-model="form.company">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id=""
                                                        placeholder="Enter Product Description" v-model="form.desc">
        ...
        deleteRecord(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    api.delete('/company-delete/' +  this.$route.params.id)
                        .then(() => {
                        ...
                        .catch(() => {
                            this.$router.push("/company_list").catch(() => { });
                        })
                    Swal.fire(
                        'Deleted!',
