                                    ...
                                    <form class="user" @submit.prevent="addEmployee" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <datepicker v-model="form.dob" :bootstrap-styling=true></datepicker>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label>Contact</label>
                                                    <input type="text" class="form-control" id="" v-model="form.contact">
                                                    <small class="text-danger" v-if="errors.contact">{{ errors.contact[0]
                                                    }}</small>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <small class="text-danger" v-if="errors.doctor">{{ errors.doctor[0]
                                                    }}</small>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <small class="text-danger" v-if="errors.mstatus">{{ errors.mstatus[0]
                                                    }}</small>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <small class="text-danger" v-if="errors.phic">{{ errors.phic[0]
                                                    }}</small>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <small class="text-danger" v-if="errors.ptype">{{ errors.ptype[0]
                                                    }}</small>
                                                </div>
                                            </div>
                                        </div>
...
export default {
    ...
    methods: {
        addEmployee() {
            ...
            if (this.isNew) {
                api.post('patients-add', this.form)
                    .then(response => {
