                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header">
                      ...
                      <router-link to="/patients_add/0" class="btn btn-primary">Add</router-link>
                    </div>
                    ...
                    <div class="card-body"> 
                      ...
                      <ul class="list-group">
                          <input type="text" v-model="form.searchTerm2" @change="filterEmployee()" class="form-control to-right" style="width:100%;" placeholder="Search patients here"> 
          ...
          /* async  check_doctors_detail(id) {   
            ...
            filterEmployee(){                   
              ...
              this.isHidden =  false
                ...
                axios.post('/api/patients',this.form)
            ...
            test(){
              this.isHidden =  false     
                axios.post('/api/patients-import', {
