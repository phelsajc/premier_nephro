      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item" :class="{ 'menu-open': this.$route.name == 'phic_list' || this.$route.name == 'copay_list' || this.$route.name == 'batch_report' || this.$route.name == 'acpn_report' || this.$route.name == 'acpn_list' }">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <router-link to="/copay_list" class="collapse-item"> <a href="#" class="nav-link" id="usermenu"
                    :class="{ 'active': this.$route.name == 'copay_list' }">
                    <i class="far fa-circle nav-icon"></i>
                    Co-Pay
                  </a></router-link>
              </li>
              <li class="nav-item">
                <router-link to="/phic_list" class="collapse-item"> <a href="#" class="nav-link" id="usermenu"
